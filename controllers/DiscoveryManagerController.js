...
const deviceController = require('./ConnectableDeviceController');
...
function startDiscovery() {
    ...
    ConnectSDK.eventEmitter.addListener('devicefound', deviceFound);
	ConnectSDK.eventEmitter.addListener('deviceupdated', deviceUpdated);
	ConnectSDK.eventEmitter.addListener('devicelost', deviceLost);
}

function stopDiscovery() {
	ConnectSDK.discoveryManager.stopDiscovery();
	ConnectSDK.eventEmitter.removeListener('devicefound');
	ConnectSDK.eventEmitter.removeListener('deviceupdated');
	ConnectSDK.eventEmitter.removeListener('devicelost');
}
